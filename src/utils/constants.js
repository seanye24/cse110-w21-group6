...
export const POMODORO_ANNOUNCEMENT = 'Currently in a pomodoro.';
export const SHORT_BREAK_ANNOUNCEMENT = 'Currently in a short break.';
export const LONG_BREAK_ANNOUNCEMENT = 'Currently in a long break.';
